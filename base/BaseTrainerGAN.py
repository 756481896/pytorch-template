...
class BaseTrainerGAN:
    """
    Base class for all trainers
    """

    def __init__(self, modelD, modelG, loss1, loss2, metrics, optimizerD, optimizerG, resume, config, train_logger=None):
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        """
        arch = type(self.modelG).__name__
        state = {
            'arch': arch,
            'epoch': epoch,
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        self.modelG.load_state_dict(checkpoint['state_dict'])
